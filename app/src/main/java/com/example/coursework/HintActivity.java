...
public class HintActivity extends AppCompatActivity {
    ...
    private void switchTimer() {
        ...
        countDownTimer = new CountDownTimer(21000, 1000) {
            ...
            public void onFinish() {
                correctOrWrong = findViewById(R.id.answerImageLabel);
    ...
    public void findViews() {
        hint_image = findViewById(R.id.iv_car_hint);
        hintLetters_tv = findViewById(R.id.textViewLetter);
        buttonSubmit = findViewById(R.id.identify_button_hint);
        editTextHint = findViewById(R.id.editTextWordHint);
        displayCorrectCarName = findViewById(R.id.correctAnswerHint);
    ...
    public void storeCarBrandAnswer() {
        random = Cars.getLastRandomIndex();
    ...
    public void begin() {
        ...
        final EditText editText_wordHint = findViewById(R.id.editTextWordHint);
    ...
    public void newCar() {
        ...
        hintLetters_tv.setTextColor(Color.rgb(255, 255, 255));
        begin();
    }
